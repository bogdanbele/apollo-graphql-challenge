...
const SecretValueCalculator = () => {
  ...
  const [fetchExposure, { loading, error, data, client }] = useLazyQuery(
    FETCH_EXPOSURE,
    {
  ...
  return (
    <CardWrapper style={{ width: 500 }}>
      ...
      <p>
        We have developed an in-house tool to calculate a user's exposure to the
        virus. We predict it's around 94% accurate.
      </p>
      ...
      {data && (
        <ModalPortal>
          <CardHeader
            title="Success"
            subheader="Your calculation is completed"
          />
          <CardContent>
            <span>The amount of exposure is </span>
